...
use crate::{
    events::IoEvents,
    fs::{ inode_handle::FileIo, fs_resolver::FsResolver},
    prelude::*,
...
fn add_disk_node(index: usize, name: &String, device: &Arc<dyn BlockDevice>, fs_resolver: &FsResolver) {
